...
public class AppConfig {
    ...
    public static final String VIDEO_DIRECTORY = "C:/Users/manoj/eclipse-workspace/VideoPlayer/videos/";
    ...
    public static final String PLAYLIST_API = VideoServlet_API_URL + "?playlist=";
